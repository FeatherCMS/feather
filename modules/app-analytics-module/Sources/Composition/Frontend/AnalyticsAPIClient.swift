...
public struct AnalyticsAdminAPIClient: Sendable {
    ...
    public func withOpenAPIRepositoryErrorMapping<T: Sendable>(
        _ operation: @Sendable (AnalyticsAdminAPI.Client) async throws -> T
...
public struct AnalyticsAppAPIClient: Sendable {
    public let client: AnalyticsAppAPI.Client
    ...
    public func withOpenAPIRepositoryErrorMapping<T: Sendable>(
        _ operation: @Sendable (AnalyticsAppAPI.Client) async throws -> T
    ) async throws(OpenAPIRepositoryError) -> T {
        do {
            return try await operation(client)
        }
