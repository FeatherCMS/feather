...
public struct Client: APIProtocol {
    ...
    public func appNewsletterCampaignSubscribe(_ input: Operations.AppNewsletterCampaignSubscribe.Input) async throws -> Operations.AppNewsletterCampaignSubscribe.Output {
    ...
    public func appNewsletterCampaignUnsubscribe(_ input: Operations.AppNewsletterCampaignUnsubscribe.Input) async throws -> Operations.AppNewsletterCampaignUnsubscribe.Output {
        try await client.send(
            input: input,
...
public func unsafeOpenAPIGenerationHotfixForAppNewsletterModuleAppClient(
