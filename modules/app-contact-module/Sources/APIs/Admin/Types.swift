...
public protocol APIProtocol: Sendable {
    ...
    func contactFormRemove(_ input: Operations.ContactFormRemove.Input) async throws -> Operations.ContactFormRemove.Output
    ...
    func contactFieldRemove(_ input: Operations.ContactFieldRemove.Input) async throws -> Operations.ContactFieldRemove.Output
    ...
    func contactFormSubmissionRemove(_ input: Operations.ContactFormSubmissionRemove.Input) async throws -> Operations.ContactFormSubmissionRemove.Output
...
extension APIProtocol {
    ...
    public func contactFormRemove(
        ...
        try await contactFormRemove(Operations.ContactFormRemove.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    public func contactFieldRemove(
        ...
        try await contactFieldRemove(Operations.ContactFieldRemove.Input(
            headers: headers,
            body: body
        ))
    }
    ...
    public func contactFormSubmissionRemove(
        ...
        try await contactFormSubmissionRemove(Operations.ContactFormSubmissionRemove.Input(
            path: path,
            headers: headers,
            body: body
        ))
...
public enum Operations {
    ...
    public enum ContactFormRemove {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Headers: Sendable, Hashable {
                public var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.ContactFormRemove.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - accept:
                public init(accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.ContactFormRemove.AcceptableContentType>] = .defaultValues()) {
                    self.accept = accept
                }
            }
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// - Throws: An error if `self` is not `.unauthorized`.
            /// - SeeAlso: `.unauthorized`.
            public var unauthorized: Operations.ContactFormRemove.Output.Unauthorized {
                get throws {
                    switch self {
                    case let .unauthorized(response):
                        return response
    ...
    public enum ContactFormGet {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Path: Sendable, Hashable {
                ...
                public var contactFormKey: Components.Parameters.ContactFormKeyParameter
                /// Creates a new `Path`.
                ///
                /// - Parameters:
                ///   - contactFormKey:
                public init(contactFormKey: Components.Parameters.ContactFormKeyParameter) {
    ...
    public enum ContactFieldRemove {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Headers: Sendable, Hashable {
                public var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.ContactFieldRemove.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - accept:
                public init(accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.ContactFieldRemove.AcceptableContentType>] = .defaultValues()) {
                    self.accept = accept
                }
            }
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// - Throws: An error if `self` is not `.unauthorized`.
            /// - SeeAlso: `.unauthorized`.
            public var unauthorized: Operations.ContactFieldRemove.Output.Unauthorized {
                get throws {
                    switch self {
                    case let .unauthorized(response):
                        return response
    ...
    public enum ContactFormSubmissionRemove {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Headers: Sendable, Hashable {
                public var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.ContactFormSubmissionRemove.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - accept:
                public init(accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.ContactFormSubmissionRemove.AcceptableContentType>] = .defaultValues()) {
                    self.accept = accept
                }
            }
            public var headers: Operations.ContactFormSubmissionRemove.Input.Headers
            public var body: Components.RequestBodies.DeleteRequestBody
            /// Creates a new `Input`.
            ///
            /// - Parameters:
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            ///
            /// HTTP response code: `401 unauthorized`.
            case unauthorized(Operations.ContactFormSubmissionRemove.Output.Unauthorized)
            /// Unauthorized
            ///
            /// - Remark: Generated from `#/paths//api/v1/admin/contact/form/{contactFormKey}/submission/delete(contactFormSubmissionRemove)/responses/401`.
            ///
            ...
            /// - Throws: An error if `self` is not `.unauthorized`.
            /// - SeeAlso: `.unauthorized`.
            public var unauthorized: Operations.ContactFormSubmissionRemove.Output.Unauthorized {
                get throws {
                    switch self {
                    case let .unauthorized(response):
                        return response
            ...
            ///
            /// HTTP response code: `403 forbidden`.
            case forbidden(Operations.ContactFormSubmissionRemove.Output.Forbidden)
            /// Forbidden
            ///
            /// - Remark: Generated from `#/paths//api/v1/admin/contact/form/{contactFormKey}/submission/delete(contactFormSubmissionRemove)/responses/403`.
            ///
            ...
            /// - Throws: An error if `self` is not `.forbidden`.
            /// - SeeAlso: `.forbidden`.
            public var forbidden: Operations.ContactFormSubmissionRemove.Output.Forbidden {
                get throws {
                    switch self {
                    case let .forbidden(response):
                        return response
    ...
    public enum ContactFormSubmissionGet {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Path: Sendable, Hashable {
                ...
                public init(
                    contactFormKey: Components.Parameters.ContactFormKeyParameter,
