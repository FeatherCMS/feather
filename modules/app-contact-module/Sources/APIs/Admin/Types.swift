...
public protocol APIProtocol: Sendable {
    ...
    func formFieldRemove(_ input: Operations.FormFieldRemove.Input) async throws -> Operations.FormFieldRemove.Output
...
extension APIProtocol {
    ...
    public func formFieldRemove(
        ...
        try await formFieldRemove(Operations.FormFieldRemove.Input(
            path: path,
            headers: headers,
            body: body
        ))
...
public func unsafeOpenAPIGenerationHotfixForAppContactModuleAdminTypes(
