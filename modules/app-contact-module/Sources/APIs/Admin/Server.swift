...
extension UniversalServer where APIHandler: APIProtocol {
    ...
    fileprivate func contactFormList(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.ContactFormList.Input.Headers = .init(
    ...
    fileprivate func contactFormCreate(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.ContactFormCreate.Input.Headers = .init(
                    accept: try converter.extractAcceptHeaderIfPresent(
                        in: request.headerFields
                    )
                )
    ...
    fileprivate func contactFormRemove(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.ContactFormRemove.Input.Headers = .init(
                    accept: try converter.extractAcceptHeaderIfPresent(
                        in: request.headerFields
                    )
                )
    ...
    fileprivate func contactFieldList(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.ContactFieldList.Input.Headers = .init(
                    accept: try converter.extractAcceptHeaderIfPresent(
                        in: request.headerFields
                    )
                )
    ...
    fileprivate func contactFieldCreate(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.ContactFieldCreate.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func contactFieldRemove(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.ContactFieldRemove.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func contactFieldGet(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.ContactFieldGet.Input.Path = .init(
    ...
    fileprivate func contactFieldUpdate(
        request: HTTPTypes.HTTPRequest,
        body: OpenAPIRuntime.HTTPBody?,
        metadata: OpenAPIRuntime.ServerRequestMetadata
    ) async throws -> (HTTPTypes.HTTPResponse, OpenAPIRuntime.HTTPBody?) {
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.ContactFieldUpdate.Input.Path = .init(
                    formFieldId: try converter.getPathParameterAsURI(
                        in: metadata.pathParameters,
                        name: "formFieldId",
                        as: Components.Parameters.FormFieldIdParameter.self
    ...
    fileprivate func contactFormSubmissionList(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                ...
                let headers:
                    Operations.ContactFormSubmissionList.Input.Headers = .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
                    )
    ...
    fileprivate func contactFormSubmissionGet(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                ...
                let headers: Operations.ContactFormSubmissionGet.Input.Headers =
                    .init(
                        accept: try converter.extractAcceptHeaderIfPresent(
                            in: request.headerFields
                        )
    ...
    fileprivate func contactFormSubmissionUpdate(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                ...
                case "application/json":
                    body = try await converter.getRequiredRequestBodyAsJSON(
                        Components.Schemas.ContactFormSubmissionPatchSchema
                            .self,
                        from: requestBody,
                        transforming: { value in
                            .json(value)
