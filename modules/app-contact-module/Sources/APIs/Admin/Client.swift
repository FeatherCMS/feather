...
public struct Client: APIProtocol {
    ...
    public func formFieldRemove(_ input: Operations.FormFieldRemove.Input) async throws -> Operations.FormFieldRemove.Output {
        try await client.send(
            input: input,
...
public func unsafeOpenAPIGenerationHotfixForAppContactModuleAdminClient(
