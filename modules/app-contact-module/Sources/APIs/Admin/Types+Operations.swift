...
public enum Operations {
    ...
    public enum FormFieldRemove {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Headers: Sendable, Hashable {
                public var accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.FormFieldRemove.AcceptableContentType>]
                /// Creates a new `Headers`.
                ///
                /// - Parameters:
                ///   - accept:
                public init(accept: [OpenAPIRuntime.AcceptHeaderContentType<Operations.FormFieldRemove.AcceptableContentType>] = .defaultValues()) {
                    self.accept = accept
                }
            }
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// - Throws: An error if `self` is not `.unauthorized`.
            /// - SeeAlso: `.unauthorized`.
            public var unauthorized: Operations.FormFieldRemove.Output.Unauthorized {
                get throws {
                    switch self {
                    case let .unauthorized(response):
                        return response
...
public func unsafeOpenAPIGenerationHotfixForAppContactModuleAdminTypesOperations(
