...
extension APIProtocol {
    ...
    public func registerHandlers(
        ...
        try transport.register(
            ...
            method: .get,
            path: server.apiPathComponentsWithServerPrefix("/api/v1/contact/form/{contactFormKey}")
        )
        try transport.register(
            {
            ...
            method: .post,
            path: server.apiPathComponentsWithServerPrefix("/api/v1/contact/form/{contactFormKey}/submit")
        )
    }
}
...
fileprivate extension UniversalServer where APIHandler: APIProtocol {
    ...
    func appContactFormGet(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.AppContactFormGet.Input.Path = .init(contactFormKey: try converter.getPathParameterAsURI(
                    in: metadata.pathParameters,
                    name: "contactFormKey",
                    as: Components.Parameters.AppContactFormKeyParameter.self
                ))
    ...
    func appContactFormSubmission(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.AppContactFormSubmission.Input.Path = .init(contactFormKey: try converter.getPathParameterAsURI(
                    in: metadata.pathParameters,
                    name: "contactFormKey",
                    as: Components.Parameters.AppContactFormKeyParameter.self
                ))
...
public func unsafeOpenAPIGenerationHotfixForAppContactModuleAppServer(
