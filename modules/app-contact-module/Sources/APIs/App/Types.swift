...
extension APIProtocol {
    ...
    public func appContactFormGet(
        ...
        try await appContactFormGet(
            Operations.AppContactFormGet.Input(
                path: path,
                headers: headers
            )
        )
    ...
    public func appContactFormSubmission(
        ...
        try await appContactFormSubmission(
            Operations.AppContactFormSubmission.Input(
                path: path,
                headers: headers,
                body: body
            )
...
public enum Components {
    ...
    public enum Parameters {
        ...
        public typealias AppContactFormIdParameter = Components.Schemas
            .AppContactIdField
    }
            ...
            public struct Headers: Sendable, Hashable {
                public var accept:
                    [OpenAPIRuntime.AcceptHeaderContentType<
                        Operations.AppContactFormGet.AcceptableContentType
                    >]
    ...
    public enum AppContactFormSubmission {
        ...
        public struct Input: Sendable, Hashable {
            ...
            public struct Headers: Sendable, Hashable {
                public var accept:
                    [OpenAPIRuntime.AcceptHeaderContentType<
                        Operations.AppContactFormSubmission
            ...
            public var headers:
                Operations.AppContactFormSubmission.Input.Headers
            public var body:
                Components.RequestBodies.AppContactFormSubmissionRequestBody
            /// Creates a new `Input`.
            ///
            /// - Parameters:
            ///   - path:
            ...
            public init(
                path: Operations.AppContactFormSubmission.Input.Path,
                headers: Operations.AppContactFormSubmission.Input.Headers =
                    .init(),
                body: Components.RequestBodies
                    .AppContactFormSubmissionRequestBody
            ) {
                self.path = path
                self.headers = headers
                self.body = body
        ...
        @frozen public enum Output: Sendable, Hashable {
            ...
            /// - SeeAlso: `.created`.
            public var created:
                Components.Responses.AppContactFormSubmissionResponse
            {
                get throws {
                    switch self {
