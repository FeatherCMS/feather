...
extension APIProtocol {
    ...
    public func registerHandlers(
        ...
        try transport.register(
            ...
            method: .post,
            path: server.apiPathComponentsWithServerPrefix("/api/v1/admin/media/assets/lookup")
        )
        try transport.register(
            {
...
fileprivate extension UniversalServer where APIHandler: APIProtocol {
    ...
    func mediaAssetNodeDelete(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaAssetNodeDelete.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
    ...
    func mediaAssetSearch(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                ...
                case "application/json":
                    body = try await converter.getRequiredRequestBodyAsJSON(
                        Components.Schemas.MediaAssetNodeSearchItemSearchQuerySchema.self,
                        from: requestBody,
                        transforming: { value in
                            .json(value)
                        }
    ...
    func mediaAssetLookup(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaAssetLookup.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
    ...
    func mediaProcessorDelete(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaProcessorDelete.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
                let body: Components.RequestBodies.DeleteRequestBody
                let chosenContentType = try converter.bestContentType(
                    received: contentType,
