...
extension APIProtocol {
    ...
    public func registerHandlers(
        ...
        try transport.register(
            ...
            method: .post,
            path: server.apiPathComponentsWithServerPrefix("/api/v1/admin/media/assets/list")
        )
        try transport.register(
            {
            ...
            method: .post,
            path: server.apiPathComponentsWithServerPrefix("/api/v1/admin/media/assets/resolve")
        )
        try transport.register(
            {
        ...
        try transport.register(
            ...
            method: .post,
            path: server.apiPathComponentsWithServerPrefix("/api/v1/admin/media/folders/list")
        )
        try transport.register(
            {
...
fileprivate extension UniversalServer where APIHandler: APIProtocol {
    ...
    func mediaAssetNodeRemove(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaAssetNodeRemove.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
    ...
    func mediaAssetList(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaAssetList.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
    ...
    func mediaAssetResolve(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaAssetResolve.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
    ...
    func mediaFolderList(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaFolderList.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
