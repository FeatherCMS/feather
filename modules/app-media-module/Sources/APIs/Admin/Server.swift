...
fileprivate extension UniversalServer where APIHandler: APIProtocol {
    ...
    func mediaAssetBulkDelete(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaAssetBulkDelete.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
    ...
    func mediaFolderBulkDelete(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaFolderBulkDelete.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
                let body: Components.RequestBodies.BulkDeleteRequestBody
                let chosenContentType = try converter.bestContentType(
                    received: contentType,
    ...
    func mediaProcessorBulkDelete(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.MediaProcessorBulkDelete.Input.Headers = .init(accept: try converter.extractAcceptHeaderIfPresent(in: request.headerFields))
                let contentType = converter.extractContentTypeIfPresent(in: request.headerFields)
                let body: Components.RequestBodies.BulkDeleteRequestBody
                let chosenContentType = try converter.bestContentType(
                    received: contentType,
