...
public struct Client: APIProtocol {
    ...
    public func mediaAssetNodeRemove(_ input: Operations.MediaAssetNodeRemove.Input) async throws -> Operations.MediaAssetNodeRemove.Output {
        try await client.send(
            input: input,
    ...
    public func mediaAssetList(_ input: Operations.MediaAssetList.Input) async throws -> Operations.MediaAssetList.Output {
        try await client.send(
            input: input,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Components.Responses.MediaAssetNodeSearchItemSearchSchemaSearchResponse.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.MediaAssetNodeSearchItemSearchSchema.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    public func mediaAssetResolve(_ input: Operations.MediaAssetResolve.Input) async throws -> Operations.MediaAssetResolve.Output {
        try await client.send(
            input: input,
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Components.Responses.MediaAssetResolveResponse.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func mediaFolderList(_ input: Operations.MediaFolderList.Input) async throws -> Operations.MediaFolderList.Output {
        try await client.send(
            input: input,
    ...
    public func mediaVariantCreate(_ input: Operations.MediaVariantCreate.Input) async throws -> Operations.MediaVariantCreate.Output {
        try await client.send(
            ...
            deserializer: { response, responseBody in
                ...
                case 201:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Components.Responses.MediaVariantDetailResponse.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
    ...
    public func mediaVariantList(_ input: Operations.MediaVariantList.Input) async throws -> Operations.MediaVariantList.Output {
        try await client.send(
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Components.Responses.MediaVariantListItemSearchSchemaSearchResponse.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.MediaVariantListItemSearchSchema.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    public func mediaVariantProcessorCreate(_ input: Operations.MediaVariantProcessorCreate.Input) async throws -> Operations.MediaVariantProcessorCreate.Output {
        try await client.send(
            ...
            deserializer: { response, responseBody in
                ...
                case 201:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Components.Responses.MediaVariantProcessorDetailResponse.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.MediaVariantProcessorDetailSchema.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
    ...
    public func mediaVariantProcessorList(_ input: Operations.MediaVariantProcessorList.Input) async throws -> Operations.MediaVariantProcessorList.Output {
        try await client.send(
            ...
            deserializer: { response, responseBody in
                ...
                case 200:
                    let contentType = converter.extractContentTypeIfPresent(in: response.headerFields)
                    let body: Components.Responses.MediaVariantProcessorListItemSearchSchemaSearchResponse.Body
                    let chosenContentType = try converter.bestContentType(
                        received: contentType,
                        options: [
                            "application/json"
                    ...
                    case "application/json":
                        body = try await converter.getResponseBodyAsJSON(
                            Components.Schemas.MediaVariantProcessorListItemSearchSchema.self,
                            from: responseBody,
                            transforming: { value in
                                .json(value)
                            }
...
public func unsafeOpenAPIGenerationHotfixForAppMediaModuleAdminClient(
