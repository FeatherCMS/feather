        ...
        static func empty() -> Self {
            .init(
                ...
                isRequired: .init(
                    name: "isRequired",
                    label: "Generation",
                    checkboxLabel: "Required variant",
                    isChecked: false
                ),
                isActive: .init(
                    name: "isActive",
                    label: "Status",
                    checkboxLabel: "Active variant",
                    isChecked: true
                ),
                error: nil
            )
        ...
        static func from(input: MediaVariantFormInput?) -> Self {
            ...
            return .init(
                ...
                isRequired: .init(
                    ...
                    label: "Generation",
                    checkboxLabel: "Required variant",
                    isChecked: input.isRequired.value
                ),
                isActive: .init(
                    name: "isActive",
                    label: "Status",
                    checkboxLabel: "Active variant",
                    isChecked: input.isActive.value
                ),
                error: nil
            )
        }
        ...
        static func from(
            ...
            .init(
                ...
                isRequired: .init(
                    ...
                    label: "Generation",
                    checkboxLabel: "Required variant",
                    isChecked: detail.isRequired
                ),
                isActive: .init(
                    name: "isActive",
                    label: "Status",
                    checkboxLabel: "Active variant",
                    isChecked: detail.isActive
                ),
                error: nil
            )
        }
