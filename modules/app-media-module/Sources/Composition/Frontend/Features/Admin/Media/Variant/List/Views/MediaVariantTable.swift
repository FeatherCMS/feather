                        ...
                        if hasActiveQuery {
                            context.build(
                                NewAdminListNoResultsState(
                                    message:
                                        "No media variants match your search.",
                                    icon: FeatherIcons.inbox(),
                                    action: {
                                        context.build(
                                            NewAdminButton(
                                                "Reset search",
                                                href: MediaVariantRoutes.list
                                                    .description,
                                                style: .secondary
                                            )
                                        )
                                ...
                                NewAdminListEmptyState(
                                    ...
                                    action: {
                                        if permissions.allows(
                                            MediaPermissions.Variants.create
                                        ) {
                                            context.build(
                                                NewAdminButton(
                                                    "Add new",
                                                    href: MediaVariantRoutes.add
                                                        .description
                                                )
                                            )
                                        }
                            ...
                            NewAdminListSelectionForm(
                                state: .init(
                                    action: NewAdminLocation.remove(
                                        path: MediaVariantRoutes.remove
                                            .description,
                                        ids: [],
                                        returnTo: returnTo
                                    ),
                ...
                NewAdminListRowActions(
                    ...
                    actions: [
                        .init(
                            "Edit",
                            href:
                                MediaVariantRoutes.edit(RouterPath(variant.id))
                                .description,
                            style: .ghost(.primary),
                            permission: MediaPermissions.Variants.update
                        ),
                        .init(
                            "Remove",
                            ...
                            style: .destructive,
                            permission: MediaPermissions.Variants.delete
                        ),
                    ],
