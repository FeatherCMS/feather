...
public struct MediaBackend: Sendable {
    ...
    public init(
        ...
        self.infrastructure = .init(
            ...
            mediaStorageRootPath: mediaStorageRootPath,
...
extension MediaBackend {
    ...
    public func enqueueVariantGeneration(
        ...
        for processor in processors {
            try await infrastructure.variantQueue.enqueueMediaGenerateVariant(
                assetId: assetId,
    ...
    public func makeSearchProcessors() -> SearchMediaProcessors {
        .init(authorizer: authorizer, transaction: writeTransaction())
    }

    public func makeGetProcessor() -> GetMediaProcessor {
        .init(authorizer: authorizer, transaction: writeTransaction())
    }

    public func makeEditProcessor() -> EditMediaProcessor {
        .init(authorizer: authorizer, transaction: writeTransaction())
    }

    public func makeDeleteProcessor() -> DeleteMediaProcessor {
        .init(authorizer: authorizer, transaction: writeTransaction())
    }
