...
struct MediaVariantIdField: StringSchemaRepresentable { var example: String? = "V1StGXR8_Z5jdHi6B-myT" }
struct MediaVariantKeyField: StringSchemaRepresentable { var example: String? = "preview" }
struct MediaVariantNameField: StringSchemaRepresentable { var example: String? = "Preview" }
struct MediaVariantExtensionsField: StringSchemaRepresentable { var example: String? = "png,jpg,jpeg,bmp" }
struct MediaVariantCommandField: StringSchemaRepresentable { var example: String? = "convert {input.fullname} -resize 256x256 {output.fullname}" }
struct MediaVariantBooleanField: BoolSchemaRepresentable { var example: Bool? = true }
struct MediaVariantTimestampField: DoubleSchemaRepresentable { var example: Double? = 1_717_171_717 }
...
struct MediaVariantProcessorListField: ArraySchemaRepresentable {
    var items: SchemaRepresentable? { MediaVariantProcessorListItemSchema().reference() }
}
