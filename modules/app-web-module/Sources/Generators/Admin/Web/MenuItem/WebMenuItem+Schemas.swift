...
struct WebMenuItemAuthenticationField: StringSchemaRepresentable {
...
struct WebMenuItemCreateSchema: ObjectSchemaRepresentable {
    var propertyMap: SchemaMap {
        [
            ...
            "authentication": WebMenuItemAuthenticationField()
...
struct WebMenuItemListItemSchema: ObjectSchemaRepresentable {
    var propertyMap: SchemaMap {
        [
            ...
            "authentication": WebMenuItemAuthenticationField().reference(),
