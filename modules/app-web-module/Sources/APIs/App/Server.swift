...
extension UniversalServer where APIHandler: APIProtocol {
    ...
    fileprivate func webSiteSettings(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let headers: Operations.WebSiteSettings.Input.Headers = .init(
        ...
        try await handle(
            ...
            deserializer: { request, requestBody, metadata in
                let path: Operations.WebMetadataGet.Input.Path = .init(
                    slug: try converter.getPathParameterAsURI(
