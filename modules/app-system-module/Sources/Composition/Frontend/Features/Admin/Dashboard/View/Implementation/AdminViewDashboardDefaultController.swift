...
struct AdminViewDashboardDefaultController: AdminViewDashboardController {
    let apiBuilder: SystemAPIBuilder
    let buildRuntime:
    ...
    func getHome(
        ...
        let model = try await interactor.getHome(
            context: .init(
                // TODO: pass api instead of these. AdminDashboardEventContext should have AuthenticatedRequestContext
                apiBaseURL: apiBuilder.baseURL,
