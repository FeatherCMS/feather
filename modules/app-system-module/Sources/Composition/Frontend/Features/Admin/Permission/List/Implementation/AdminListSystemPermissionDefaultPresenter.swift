    ...
    AdminListSystemPermissionPresenter
{
    ...
    func renderListPage(
        ...
        let canAccess = permissions.contains(SystemPermissions.Permissions.list.rawValue)
        if let error {
        ...
        return renderEngine.renderAdminPage(
            ...
            content: SystemPermissionTable(
                state: .init(
                    ...
                    canAccess: canAccess,
                    permissions: permissions,
                    canAdd: permissions.contains(SystemPermissions.Permissions.create.rawValue),
                    items: model.items,
                    page: model.page,
