...
struct AdminGetAccountProfileDefaultController:
    AdminGetAccountProfileController
{
    let buildRuntime:
        @Sendable (Request, DefaultRequestContext) -> (
            interactor: any AdminGetAccountProfileInteractor,
            presenter: any AdminGetAccountProfilePresenter
        )
