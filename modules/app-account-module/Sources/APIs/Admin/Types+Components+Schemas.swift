...
extension Components {
    ...
    public enum Schemas {
        ...
        public typealias AccountInvitationListSchema = [Components.Schemas.AccountInvitationListItemSchema]
...
public func unsafeOpenAPIGenerationHotfixForAppAccountModuleAdminTypesComponentsSchemas(
