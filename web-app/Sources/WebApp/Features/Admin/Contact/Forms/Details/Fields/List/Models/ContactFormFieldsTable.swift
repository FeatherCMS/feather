        ...
        Section {
            ...
            if state.fields.isEmpty {
                ...
                ListTableBulkRemoveForm(
                    state: .init(action: "\(basePath)/remove/", page: 1, search: state.search, canRemove: state.canRemove, buttonTitle: "Remove selected"),
                        ...
                        table: Table {
                            ...
                            Tbody {
                                for field in state.fields {
                                    Tr {
                                        if state.canRemove { ListTableRowSelectCheckbox(state: .init(id: field.id)) }
