    ...
    AdminRemoveContactFieldPresenter
{
    ...
    func renderBulkConfirmation(
        selectedIds: [String], permissions: Set<String>
    ) -> HTMLResponse {
        renderEngine.renderAdminPage(
            request: request, title: "Remove contact fields - Feather CMS",
            description: "Remove contact fields", imagePath: "images/puppy.png",
            ...
            content: ListBulkRemoveConfirmation(state: .init(
                ...
                message: "Are you sure you want to remove the selected contact fields? This action cannot be undone.",
