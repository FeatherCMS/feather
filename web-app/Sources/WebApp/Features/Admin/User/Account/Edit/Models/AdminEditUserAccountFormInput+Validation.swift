...
enum AdminEditUserAccountFormFieldValidator {
...
extension AdminEditUserAccountFormInput {

    private var validator: GroupValidator {
        GroupValidator {
            AdminEditUserAccountFormFieldValidator.email(email, required: true)
            AdminEditUserAccountFormFieldValidator.password(
                password,
                required: false
            )
        }
