...
struct AdminEditAuthCredentialDefaultController: AdminEditAuthCredentialController {
    ...
    func getEditCredential(request: Request, context: AppRequestContext) async throws -> HTMLResponse {
        ...
        do {
            ...
            return presenter.renderPage(
                id: id,
                form: presenter.formState(email: credential.email, password: ""),
    ...
    func postEditCredential(request: Request, context: AppRequestContext) async throws -> Response {
        ...
        do {
            ...
            return try presenter.renderPage(id: id, form: state, permissions: context.currentUserPermissions)
