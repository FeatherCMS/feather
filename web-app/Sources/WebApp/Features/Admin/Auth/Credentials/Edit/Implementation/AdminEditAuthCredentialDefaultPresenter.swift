...
struct AdminEditAuthCredentialDefaultPresenter: AdminEditAuthCredentialPresenter {
    ...
    func renderPage(id: String, form: AuthCredentialForm.State, permissions: Set<String>) -> HTMLResponse {
        renderEngine.renderAdminPage(
            ...
            content: AuthCredentialEdit(state: .init(id: id, form: form, breadcrumb: breadcrumb(id: id)))
        )
    }
    ...
    func formState(email: String, password: String = "") -> AuthCredentialForm.State {
        .init(
            ...
            password: .init(key: "password", label: "New password", value: password, error: nil),
