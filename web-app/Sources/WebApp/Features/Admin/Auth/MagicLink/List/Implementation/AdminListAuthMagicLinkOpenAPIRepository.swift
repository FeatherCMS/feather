    ...
    AdminListAuthMagicLinkRepository
{
    ...
    func list(
        ...
        items: [Components.Schemas.UserMagicLinkListItemSchema], total: Int,
        page: Int, size: Int
    ) {
        try await api.withOpenAPIRepositoryErrorMapping { client in
            ...
            case .forbidden:
                throw OpenAPIRepositoryError.forbidden(
                    message: "Your account cannot access user magic links."
                )
    ...
    func delete(
        ...
        try await api.withOpenAPIRepositoryErrorMapping { client in
            ...
            case .forbidden:
                throw OpenAPIRepositoryError.forbidden(
                    message: "Your account cannot delete user magic links."
                )
            case .undocumented(let statusCode, let response):
                throw try await api.failure(
                    statusCode: statusCode,
