...
struct AdminManageNewslettersDefaultPresenter: AdminManageNewslettersPresenter {
    ...
    func renderList(
        items: [AdminManageNewsletterItem],
        isAdded: Bool,
        isEdited: Bool,
        isRemoved: Bool,
        isPicker: Bool,
    ...
    func renderBulkRemoveConfirmation(
        ...
        renderEngine.renderAdminPage(
            request: request,
            title: "Remove campaigns - Feather CMS",
            ...
            content: ListBulkRemoveConfirmation(
                state: .init(
                    ...
                    message:
                        "Are you sure you want to remove the selected campaigns? This action cannot be undone.",
    ...
    func renderEdit(
        item: AdminManageNewsletterItem,
        error: String?,
        permissions: Set<String>
    ) -> HTMLResponse {
        renderEngine.renderAdminPage(
            request: request,
            title: "Campaign details - Feather CMS",
            ...
            content: NewsletterEdit(
                state: .init(
                    ...
                    breadcrumb: breadcrumb(
                        label: "Details",
                        path: "/admin/newsletters/\(item.id)/details/"
                    )
                )
            )
        )
    ...
    private func breadcrumb(label: String? = nil, path: String? = nil)
