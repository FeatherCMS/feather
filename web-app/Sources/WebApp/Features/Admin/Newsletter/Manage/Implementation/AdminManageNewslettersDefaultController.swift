...
struct AdminManageNewslettersDefaultController: AdminManageNewslettersController
{
    let buildRuntime:
        @Sendable (Request, AppRequestContext) -> (
            interactor: any AdminManageNewslettersInteractor,
            presenter: any AdminManageNewslettersPresenter
        )
        ...
        async throws -> HTMLResponse
    {
        ...
        return presenter.renderBulkRemoveConfirmation(
            page: page,
            search: search,
            ...
            headers: [
                .location: ListBulkRemoveRedirect.location(
                    ...
                    message: payload.normalizedSelectedIds.isEmpty
                        ? nil : "Campaigns removed successfully."
                )
            ]
        )
    }
