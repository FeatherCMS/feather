...
struct AdminManageNewsletterSubscribersDefaultController:
    AdminManageNewsletterSubscribersController
{
    let buildRuntime:
        @Sendable (Request, AppRequestContext) -> (
            interactor: any AdminManageNewsletterSubscribersInteractor,
            presenter: any AdminManageNewsletterSubscribersPresenter
        )
        ...
        async throws -> Response
    {
        ...
        guard !subscriberIds.isEmpty else {
            return Response(
                status: .seeOther,
                headers: [
                    .location: "/admin/newsletters/\(newsletterId)/subscribers/"
                ]
            )
        }
        return
