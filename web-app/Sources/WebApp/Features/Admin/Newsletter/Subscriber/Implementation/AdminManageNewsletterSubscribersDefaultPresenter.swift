...
struct AdminManageNewsletterSubscribersDefaultPresenter:
    AdminManageNewsletterSubscribersPresenter
{
    let request: Request
        ...
        renderEngine.renderAdminPage(
            ...
            content: NewsletterSubscribersTable(
                state: .init(
                    ...
                    error: error,
                    breadcrumb: breadcrumb(newsletterId: newsletterId)
                )
            )
        )
    }
    ...
    func renderForm(
        ...
        renderEngine.renderAdminPage(
            request: request,
            title:
                "\(isEdit ? "Edit" : "Add") campaign subscriber - Feather CMS",
            description: "Manage campaign subscriber",
            imagePath: "images/puppy.png",
            sidebarState: renderEngine.adminSidebarState(
                request: request,
                permissions: permissions
    ...
    func renderRemoveConfirmation(
        ...
        renderEngine.renderAdminPage(
            ...
            content: NewsletterSubscriberRemoveView(
                email: email,
    ...
    func renderBulkRemoveConfirmation(
        ...
        renderEngine.renderAdminPage(
            request: request,
            title: "Remove selected subscribers - Feather CMS",
            description: "Confirm bulk subscriber removal",
            imagePath: "images/puppy.png",
            sidebarState: renderEngine.adminSidebarState(
                request: request,
                permissions: permissions
            ...
            content: ListBulkRemoveConfirmation(
                state: .init(
                    ...
                    message:
                        "Are you sure you want to remove these selected subscribers from this campaign? This action cannot be undone.",
                    action:
    ...
    private func breadcrumb(newsletterId: String, label: String? = nil)
        -> AdminBreadcrumb.State
    {
        var links: [AdminBreadcrumb.State.Link] = [
            ...
            .init(
                label: "Subscribers",
                link: "/admin/newsletters/\(newsletterId)/subscribers/"
            ),
        ]
