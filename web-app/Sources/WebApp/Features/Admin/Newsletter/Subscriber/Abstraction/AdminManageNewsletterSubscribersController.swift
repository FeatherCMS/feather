...
extension AdminManageNewsletterSubscribersController {
    func route(on router: Router<AppRequestContext>) {
        ...
        router.get("/admin/newsletters/:newsletterId/subscribers/:email/edit/", use: edit)
        router.post("/admin/newsletters/:newsletterId/subscribers/:email/edit/", use: update)
        router.get("/admin/newsletters/:newsletterId/subscribers/:email/remove/", use: confirmRemove)
        router.post("/admin/newsletters/:newsletterId/subscribers/:email/remove/", use: remove)
