...
struct AdminNewsletterIssueListDefaultController:
    AdminNewsletterIssueListController
{
    let buildRuntime:
        @Sendable (Request, AppRequestContext) -> (
            interactor: any AdminNewsletterIssueListInteractor,
            presenter: any AdminNewsletterIssueListPresenter
        )
