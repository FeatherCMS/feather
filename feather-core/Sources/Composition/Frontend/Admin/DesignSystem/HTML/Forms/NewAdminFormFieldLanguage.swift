...
public struct NewAdminFormFieldLanguage: Component {
    ...
    private static let languageOptions: [NewAdminFormFieldSelect.SelectOption] = [
        ...
        .init(label: "French Switzerland - (Français Suisse)", value: "fr-CH"),
        .init(label: "Galician - (Galego)", value: "gl"),
        .init(label: "Georgian - (ქართული)", value: "ka"),
        .init(label: "German - (Deutsch)", value: "de"),
        .init(label: "German Austria  - (Deutsch Österreich)", value: "de-AT"),
        .init(label: "German Germany  - (Deutsch Deutschland)", value: "de-DE"),
        .init(label: "German Liechtenstein  - (Deutsch Liechtenstein)", value: "de-LI"),
        .init(label: "German Switzerland  - (Deutsch Schweiz)", value: "de-CH"),
        ...
        .init(label: "Italian Switzerland - (Italiano - Svizzera)", value: "it-CH"),
        ...
        .init(label: "Portuguese Brazil - (Português Brasil)", value: "pt-BR"),
        .init(label: "Portuguese Portugal - (Português Portugal)", value: "pt-PT"),
        ...
        .init(label: "Spanish  Argentina  - (Español Argentina)", value: "es-AR"),
        .init(label: "Spanish  Latin America  - (Español Latinoamérica)", value: "es-419"),
        .init(label: "Spanish  Mexico  - (Español  México)", value: "es-MX"),
        .init(label: "Spanish  Spain  - (Español España)", value: "es-ES"),
        .init(label: "Spanish  United States  - (Español Estados Unidos)", value: "es-US"),
