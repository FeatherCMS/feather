...
extension NewAdminMediaAsset {
    public static func metadataImageURL(
        ...
        let pathComponents = decodedPath.split(separator: "/", omittingEmptySubsequences: true)
        ...
        let relativeAssetPath = pathComponents.dropFirst().map(String.init).joined(separator: "/")
