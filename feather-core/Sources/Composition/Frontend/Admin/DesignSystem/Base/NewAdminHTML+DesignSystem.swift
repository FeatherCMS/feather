    ...
    func rules() -> [any Rule] {
        Media {
            Root {
                ...
                Variable(TokenKey.Colors.Link.visited, "#bf3b87")
                Variable(TokenKey.Colors.Link.active, "#c53c6f")
                ...
                Variable(TokenKey.Colors.Accents.Primary.tint, "#5b438f")
                Variable(TokenKey.Colors.Accents.Primary.text, "#fff")
                Variable(TokenKey.Colors.Accents.Primary.border, "#4c347d")
                Variable(TokenKey.Colors.Accents.Primary.hover, "#8066bd")

                Variable(TokenKey.Colors.Accents.Secondary.tint, "#a83270")
                Variable(TokenKey.Colors.Accents.Secondary.text, "#fff")
                Variable(TokenKey.Colors.Accents.Secondary.border, "#8f285d")
                Variable(TokenKey.Colors.Accents.Secondary.hover, "#d15a92")

                Variable(TokenKey.Colors.Buttons.Destructive.tint, "#a61b27")
                Variable(TokenKey.Colors.Buttons.Destructive.text, "#fff")
                Variable(TokenKey.Colors.Buttons.Destructive.border, "#8f1620")
                Variable(TokenKey.Colors.Buttons.Destructive.hover, "#d13b49")
                ...
                Variable(TokenKey.Colors.Buttons.Ghost.Primary.hover, "#1f2937")

                Variable(TokenKey.Colors.Buttons.Ghost.Secondary.tint, "#d1d5db")
                Variable(TokenKey.Colors.Buttons.Ghost.Secondary.text, "#1f2937")
                Variable(TokenKey.Colors.Buttons.Ghost.Secondary.border, "#e5e7eb")
                Variable(TokenKey.Colors.Buttons.Ghost.Secondary.hover, "#e5e7eb")

                Variable(TokenKey.Colors.Buttons.Disabled.tint, "#e2e8f0")
                Variable(TokenKey.Colors.Buttons.Disabled.text, "#6b7280")
                Variable(TokenKey.Colors.Buttons.Disabled.border, "#f8fafc")
                Variable(TokenKey.Colors.Buttons.Disabled.hover, "#e2e8f0")
        ...
        Media(.prefersColorScheme(.dark)) {
            Root {
                ...
                Variable(TokenKey.Colors.Link.hover, "#7e78ff")
                Variable(TokenKey.Colors.Link.visited, "#ef5eb0")
                Variable(TokenKey.Colors.Link.active, "#ff6482")
                ...
                Variable(TokenKey.Colors.Buttons.Disabled.tint, "#e2e8f0")
                Variable(TokenKey.Colors.Buttons.Disabled.text, "#e2e8f0")
                Variable(TokenKey.Colors.Buttons.Disabled.border, "#f8fafc")
                Variable(TokenKey.Colors.Buttons.Disabled.hover, "#6b7280")
