    ...
    func rules() -> [any Rule] {
        ...
        Media(.prefersColorScheme(.dark)) {
            Root {
                ...
                Variable(TokenKey.Colors.Materials.Primary.tint, "#111113")
                Variable(TokenKey.Colors.Materials.Primary.text, "#d6d1dc")
                Variable(TokenKey.Colors.Materials.Primary.border, "#242428")
                Variable(TokenKey.Colors.Materials.Primary.hover, "#1c1c20")

                Variable(TokenKey.Colors.Materials.Secondary.tint, "#18181b")
                Variable(TokenKey.Colors.Materials.Secondary.text, "#f5f0f7")
                Variable(TokenKey.Colors.Materials.Secondary.border, "#2a2a2e")
                Variable(TokenKey.Colors.Materials.Secondary.hover, "#222226")

                Variable(TokenKey.Colors.Materials.Tertiary.tint, "#242428")
                Variable(TokenKey.Colors.Materials.Tertiary.text, "#a39aa8")
                Variable(TokenKey.Colors.Materials.Tertiary.border, "#303036")
                Variable(TokenKey.Colors.Materials.Tertiary.hover, "#2c2c30")

                Variable(TokenKey.Colors.Accents.Primary.tint, "#5b56c7")
                Variable(TokenKey.Colors.Accents.Primary.text, "#fff")
                Variable(TokenKey.Colors.Accents.Primary.border, "#4b46a8")
                Variable(TokenKey.Colors.Accents.Primary.hover, "#7c75df")

                Variable(TokenKey.Colors.Accents.Secondary.tint, "#b33b73")
                Variable(TokenKey.Colors.Accents.Secondary.text, "#fff")
                Variable(TokenKey.Colors.Accents.Secondary.border, "#96305f")
                Variable(TokenKey.Colors.Accents.Secondary.hover, "#d35e8e")
                ...
                Variable(TokenKey.Colors.Buttons.Ghost.Primary.tint, "#1f1f22")
                Variable(TokenKey.Colors.Buttons.Ghost.Primary.text, "#f5f0f7")
                Variable(TokenKey.Colors.Buttons.Ghost.Primary.border, "#3a3a3e")
                Variable(TokenKey.Colors.Buttons.Ghost.Primary.hover, "#2c2c2e")

                Variable(TokenKey.Colors.Buttons.Ghost.Secondary.tint, "#3a3a3e")
                Variable(TokenKey.Colors.Buttons.Ghost.Secondary.text, "#d6d1dc")
                Variable(TokenKey.Colors.Buttons.Ghost.Secondary.border, "#525255")
                Variable(TokenKey.Colors.Buttons.Ghost.Secondary.hover, "#525255")

                Variable(TokenKey.Colors.Buttons.Disabled.tint, "#141416")
                Variable(TokenKey.Colors.Buttons.Disabled.text, "#716a75")
                Variable(TokenKey.Colors.Buttons.Disabled.border, "#242428")
                Variable(TokenKey.Colors.Buttons.Disabled.hover, "#1f1f22")
