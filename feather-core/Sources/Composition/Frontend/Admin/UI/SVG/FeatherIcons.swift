...
public enum FeatherIcons {
    ...
    public static func activity() -> SVG {
        SVG {
    ...
    public static func alertCircle() -> SVG {
        SVG {
    ...
    static func alertOctagon() -> SVG {
        SVG {
            Polygon([
                7.86, 2, 16.14, 2, 22, 7.86, 22, 16.14, 16.14, 22, 7.86, 22, 2,
                16.14, 2, 7.86, 7.86, 2,
            ])
            Line(x1: 12, y1: 8, x2: 12, y2: 12)
            Line(x1: 12, y1: 16, x2: 12.01, y2: 16)
    ...
    public static func barChart2() -> SVG {
        SVG {
    ...
    public static func bookOpen() -> SVG {
        SVG {
    ...
    public static func briefcase() -> SVG {
        SVG {
    ...
    public static func clipboard() -> SVG {
        SVG {
            Path(
    ...
    public static func cornerUpLeft() -> SVG {
        SVG {
    ...
    public static func cornerUpRight() -> SVG {
        SVG {
    ...
    public static func externalLink() -> SVG {
        SVG {
    ...
    public static func fileText() -> SVG {
        SVG {
            Path("M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z")
            Polyline([14, 2, 14, 8, 20, 8])
    ...
    public static func gitBranch() -> SVG {
        SVG {
    ...
    public static func messageSquare() -> SVG {
        SVG {
            Path(
    ...
    public static func monitor() -> SVG {
        SVG {
    ...
    public static func playCircle() -> SVG {
        SVG {
            Circle(cx: 12, cy: 12, r: 10)
    ...
    public static func settings() -> SVG {
        SVG {
            Circle(cx: 12, cy: 12, r: 3)
            Path(
    ...
    public static func sliders() -> SVG {
        SVG {
    ...
    public static func userCheck() -> SVG {
        SVG {
