...
public struct AdminAutocompleteField: Component {
    ...
    public struct State: FeatherAdmin.Object {
        ...
        public var options: [NewAdminFormFieldSelectAutocomplete.Option]
        ...
        public init(
            ...
            label: String,
            placeholder: String,
            options: [NewAdminFormFieldSelectAutocomplete.Option],
            error: String?,
    ...
    private func encodeOptions(
        _ options: [NewAdminFormFieldSelectAutocomplete.Option]
    ) -> String {
