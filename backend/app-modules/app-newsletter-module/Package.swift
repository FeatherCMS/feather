...
var defaultSwiftSettings: [SwiftSetting] = [
    ...
    .enableExperimentalFeature(
        "AvailabilityMacro=NewsletterModule 1.0:macOS 15.0, iOS 18.0, tvOS 18.0, watchOS 11.0, visionOS 2.0"
    ),
...
let package = Package(
    ...
    products: [
        ...
        .library(
            ...
            targets: ["NewsletterApplication"]
        ),
        .library(
            name: "NewsletterInfrastructure",
            targets: ["NewsletterInfrastructure"]
        ),
    ],
    dependencies: [
        .package(
