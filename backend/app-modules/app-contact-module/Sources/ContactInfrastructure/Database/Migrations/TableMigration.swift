...
public struct TableMigration: DatabaseMigration {
    ...
    public func apply(on connection: any DatabaseConnection) async throws {
        ...
        let queries: [DatabaseQuery] = [
            ...
            VALUES
                ('contact-field-email', 'email', 'text', 'Email', '[]'::jsonb, TRUE, NOW(), NOW()),
                ('contact-field-first-name', 'firstName', 'text', 'First name', '[]'::jsonb, FALSE, NOW(), NOW()),
                ('contact-field-last-name', 'lastName', 'text', 'Last name', '[]'::jsonb, FALSE, NOW(), NOW()),
                ('contact-field-message', 'message', 'textarea', 'Message', '[]'::jsonb, FALSE, NOW(), NOW())
